...
You are done, you can visit your Symfony application on the following URL: `http://localhost` (and access Kibana on `http://localhost:81`)
...
You can also use Kibana to visualize Nginx & Symfony logs by visiting `http://localhost:81`.
